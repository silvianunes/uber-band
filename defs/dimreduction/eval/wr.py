...
space = {
    'ev_measure': hp.choice('ev', ('acc', 'rmse', 'mae', 'f-meas', 'auc', 'auprc')),
    'seed': hp.quniform('sd', 1, 1, 1),
    'threshold': hp.uniform('t', 0.01, 0.1),
...
def get_evaluator(params, base):
    ...
    evaluator = ASEvaluation(classname="weka.attributeSelection.WrapperSubsetEval", options=L)
